    ...
    context 'when :tooltip is present in the options' do
      ...
      context 'when the button is not disabled' do
        ...
        it 'outputs a button with a tooltip' do
          ...
          expect(subject).to eq "<a class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"top\" data-html=\"true\" href=\"#\" title=\"#{tested_tooltip}\"></a>"
        end
        ...
        context 'and when a title is included in the options' do
          ...
          it 'prioritizes the :tooltip value and overwrites the :title option' do
            ...
            expect(subject).to eq "<a class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"top\" data-html=\"true\" title=\"#{tested_tooltip}\" href=\"#\"></a>"
          end
        end
