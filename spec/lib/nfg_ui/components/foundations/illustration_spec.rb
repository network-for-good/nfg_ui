...
RSpec.describe NfgUi::Components::Foundations::Illustration do
  ...
  describe 'sizable utility module' do
    let(:options) { { responsive: true } }
    pending 'unable to use the sizable shared examples due to expectations that css class will always be present on the component -- to be revisited later.'
