...
*Note: when making changes to the engine (anything within the nfg_ui folders), you must restart the rails server. I'm looking into a solution for this (probably the listen gem) but haven't set it up yet*
